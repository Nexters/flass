...
class SignIn extends Component {
  ...
  onClickLoginBtn() {
    ...
    window.location = `https://oauth.classting.com/v1/oauth2/authorize?client_id=${CLASSTING_CLIENT_ID}&redirect_uri=${API_ROOT}?redirect_url=${redirectUrl}&response_type=token`;
